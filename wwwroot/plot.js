...
// var ip = local_ip;
var MATHcitations = ['Математик, который не является в известной мере поэтом, никогда не будет настоящим математиком.', 'Нельзя быть настоящим математиком, не будучи немного поэтом.', 'Математика - это язык, на котором написана книга природы.', 'Великая книга природы написана математическими символами.', 'Математика – царица наук, арифметика – царица математики.', 'Математики похожи на французов: что бы вы ни сказали, они все переведут на собственный язык. Получится нечто противоположное.', 'Часто говорят, что цифры управляют миром; по крайней мере нет сомнения в том, что цифры показывают, как он управляется.', 'Астрономия, как наука, стала существовать с тех пор, как она соединилась с математикой.', 'Математика является учением об отношениях между формулами, лишенными какого бы то ни было содержания.', '«Числа управляют миром», – говорили пифагорейцы. Но числа дают возможность человеку управлять миром, и в этом нас убеждает весь ход развития науки и техники наших дней.', 'Если теорему так и не смогли доказать, она становится аксиомой.', 'В математике есть своя красота, как в живописи и поэзии.', 'Доказательство называется строгим, если таковым его считает большинство математиков.', 'Всякий знает, что такое кривая, пока не выучится математике настолько, что вконец запутается в бесконечных исключениях.', 'Рано или поздно всякая правильная математическая идея находит применение в том или ином деле.', 'Если вы хотите участвовать в большой жизни, то наполняйте свою голову математикой, пока есть к тому возможность. Она окажет вам потом огромную помощь во всей вашей работе.', 'В каждой естественной науке заключено столько истины, сколько в ней есть математики.', '...Было бы легче остановить Солнце, легче было сдвинуть Землю, чем уменьшить сумму углов в треугольнике, свести параллели к схождению и раздвинуть перпендикуляры к прямой на расхождение.', 'Математике должно учить в школе еще с той целью, чтобы познания, здесь приобретаемые, были достаточными для обыкновенных потребностей в жизни', 'Математика уступает свои крепости лишь сильным и смелым.', 'Математические науки, естественные науки и гуманитарные науки могут быть названы, соответственно, науками сверхъестественными, естественными и неестественными.', 'Мнимые числа — это прекрасное и чудесное убежище божественного духа, почти что сочетание бытия с небытием.', 'Первое условие, которое надлежит выполнять в математике, - это быть точным, второе - быть ясным и, насколько можно, простым', 'Химия – правая рука физики, математика – ее глаз.', 'Математику уже затем учить надо, что она ум в порядок приводит.', 'Все, что до этого было в науках: гидравлика, аэрометрия, оптика и других темно, сомнительно и недостоверно, математика сделала ясным, верным и очевидным.', 'Стремящийся к ближайшему изучению химии должен быть сведущ и в математике.', 'Слеп физик без математики.', 'Математика - это язык, на котором говорят все точные науки.', 'Только с алгеброй начинается строгое математическое учение.', 'Много из математики не остается в памяти, но когда поймешь ее, тогда легко при случае вспомнить забытое.', 'Кто с детских лет занимается математикой, тот развивает внимание, тренирует свой мозг, свою волю, воспитывает настойчивость и упорство в достижении цели.', 'Легче найти квадратуру круга, чем перехитрить математика.', 'Задача заключается не в том, чтобы учить математике, а в том, чтобы при посредстве математике дисциплинировать ум.', 'Разве ты не заметил, что способный к математике изощрен во всех науках в природе?', 'Было бы хорошо, если бы эти знания требовало само государство и если бы лиц, занимающих высшие государственные должности, приучали заниматься математикой и в нужных случаях к ней обращаться.', 'Математическая истина, независимо от того, в Париже или в Тулузе, одна и та же.', 'В математических вопросах нельзя пренебрегать даже с самыми малыми ошибками.', 'Величие человека - в его способности мыслить.', 'Предмет математики столь серьезен, что не следует упускать ни одной возможности сделать его более занимательным.', 'В математике нет символов для неясных мыслей.', 'Математика — это искусство называть разные вещи одним и тем же именем.', 'Математика есть лучшее и даже единственное введение в изучение природы.', 'Я люблю математику не только потому, что она находит применение в технике, но и потому, что она красива.', 'Лучший способ изучить что-либо - это открыть самому.', 'Если вы хотите научиться плавать, то смело входите в воду, а если хотите научиться решать задачи, то решайте их!', 'Трудность решения в какой-то мере входит в само понятие задачи: там, где нет трудности, нет и задачи.', 'Если вы хотите научиться плавать, то смело входите в воду, а если хотите научиться решать задачи, то решайте их.', 'Вдохновение нужно в геометрии не меньше, чем в поэзии.', 'Геометрия полна приключений, потому что за каждой задачей скрывается приключение мысли. Решить задачу – это значит пережить приключение.', 'Счет и вычисления - основа порядка в голове.', 'Чистая математика — это такой предмет, где мы не знаем, о чем мы говорим, и не знаем, истинно ли то, что мы говорим.', 'Если бы я только имел теоремы! Тогда я бы мог бы достаточно легко найти доказательства.', 'Подобно тому как все искусства тяготеют к музыке, все науки стремятся к математике.', 'Математика может открыть определенную последовательность даже в хаосе.', 'Умственный труд на уроках математики - пробный камень мышления.', 'Чтобы переварить знания, надо поглощать их с аппетитом.', 'Пристальное, глубокое изучение природы есть источник самых плодотворных открытий математики".', 'Математики похожи на влюбленных — достаточно согласиться с простейшим утверждением математика, как он выведет следствие, с которым вновь придется согласиться, а из этого следствия — еще одно.', '...Математика - это цепь понятий: выпадет одно звенышко - и не понятно будет дальнейшее.', 'Науки математические с самой глубокой древности обращали на себя особенное внимание, в настоящее время они получили еще больше интереса по влиянию своему на искусство и промышленность.', 'Полет – это математика.', 'Правильному применению методов можно научиться только применяя их на разнообразных примерах.', 'Математика — самая надежная форма пророчества.', 'Из дома реальности легко забрести в лес математики, но лишь немногие способны вернуться обратно.', 'Легкость математики основана на возможности чисто логического ее построения, трудность, отпугивающая многих, — на невозможности иного изложения.', 'Между духом и материей посредничает математика.', 'В математике ум исключительно занят собственными формами познавания — временем и пространством, следовательно, подобен кошке, играющей собственным хвостом.', 'Доказательство - это рассуждение, которое убеждает.', 'Как и другие науки, математика возникла из практических нужд людей: из измерения площадей земельных участков и вместимости сосудов, из счисления времени и их механики.', 'Как бы машина хорошо ни работала, она может решать все требуемые от нее задачи, но она никогда не придумает ни одной.', 'Законы математики, имеющие какое-либо отношение к реальному миру, ненадежны; а надежные математические законы не имеют отношения к реальному миру.', 'Математик уже кое-что может, но, разумеется, не то, что от него хотят получить в данный момент.', 'Математика — это единственный совершенный метод водить самого себя за нос.', 'С тех пор как за теорию относительности принялись математики, я ее уже сам больше не понимаю.', 'Существует поразительная возможность овладеть предметом математически, не поняв существа дела.', 'Именно математика дает надежнейшие правила: кто им следует – тому не опасен обман чувств.'];
var MATHnames = ['К. Вейерштрасс', 'К. Вейерштрасс', 'Г. Галилей', 'Галилей', 'К.Ф. Гаусс', 'Иоганн Вольфганг Гете', 'И. Гете', 'А.И. Герцен', 'Давид Гильберт', 'А. Дородницын', 'Евклид', 'Н.Е. Жуковский', 'Моррис Клайн', 'Феликс Клейн', 'А.Н. Крылов', 'М.И. Калинин', 'И. Кант', 'В.Ф. Каган', 'Л. Карно)', 'А.П. Конфорович', 'Лев Давидович Ландау', 'Готфрид Вильгельм Лейбниц', 'Г. Лейбниц', 'М.В. Ломоносов', 'М.В. Ломоносов', 'М.В. Ломоносов', 'М.В. Ломоносов', 'М.В. Ломоносов', 'Н.И. Лобачевский', 'Н.И. Лобачевский', 'И.Л. Лобачевский', 'А. Маркушевич', 'Огастес де Морган', 'М.В. Остроградский', 'Платон', 'Платон', 'Блез Паскаль', 'Б. Паскаль', 'Б. Паскаль', 'Б. Паскаль', 'Анри Пуанкаре', 'А. Пуанкаре', 'Д.И. Писарев', 'Р. Петер', 'Д. Пойа', 'Д. Пойа', 'Д. Пойа', 'Д.Пойа', 'А.С. Пушкин', 'В. Произволов', 'Песталоцци', 'Бертран Рассел', 'Бернхард Риман', 'Джордж Сантаяна', 'Гертруда Стайн', 'В.А. Сухомлинский', 'А. Франц', 'Ж. Фурье', 'Бернар Ле Бовье де Фонтенель', 'Г. Цейтен', 'П.Л. Чебышев', 'В. Чкалов', 'В. Шрадер', 'В. Швебель', 'Хуго Штейнгаус', 'Хуго Штейнгаус', 'Хуго Штейнгаус', 'А. Шопенгауэр', 'Ю.А. Шиханович', 'Ф. Энгельс', 'А. Эйнштейн', 'Альберт Эйнштейн', 'Альберт Эйнштейн', 'Альберт Эйнштейн', 'Альберт Эйнштейн', 'Альберт Эйнштейн', 'Л. Эйлер'];
...
/* receives number of ODEs and creates them */
...
/* receives number of Equations and creates them */
...
/* receives values, number of it and type and creates and fills in ODEs/Equations */
    ...
    if (data == 'access denied') {
        ...
        profileNavHTML += `
                            ...
                            <div class="btn-group" role="group" id="profileNavbtn-group">
                                ...
                                <button type="button" class="btn btn-primary" id="profileButton">NAME</button>
                                <button type="button" class="btn btn-outline-primary" onclick="Logout()" id="logoutButton">Выйти</button>
                            </div>`;
        profileNavHTML = profileNavHTML.replace('NAME', USER['name'] + ' ' + USER['surname']);
        $('#loginButton').after(profileNavHTML);
        $('#loginButton').remove();
        $('#savedDSDropdownMenuLink').popover();
        $('#saveDSButton').popover();

        $('#SuccessLoginModalTitle').html('Добро пожаловать, ' + USER['name'] + '!');
        randomQuote = randomInteger(0, MATHcitations.length);
        $('#SuccessLoginModalQuoteText').html(MATHcitations[randomQuote]);
        $('#SuccessLoginModalQuoteAuthor').html(MATHnames[randomQuote]);
        $('#SuccessLoginModal').modal('show');
        //alert('Добро пожаловать, ' + USER['name'] + '!');
    }
}
/* processes logout sequence */
function Logout(){
    login = false;
...
/* saves current dynamic system to user account and update layout */
...
/* processes save dynamic system sequence's server answer */
function successSaveUserDynamicSystem(data){
    $('#SaveDSModal').modal('toggle');
}
/* processes delete dynamic system sequence's server answer */
...
function processData(allRows, type) {
    ...
    makePlots(ndims, equationTimeSeries, lyapunovTimeSeries);
    //-----------------------------------------------------------
    successAlert(false);
    updateLayout();
}
...
// Plots -----------------------------------------------------------------------------
function makePlots(ndims, equationTimeSeries, lyapunovTimeSeries){
    // make plots -----------------------------------------------
